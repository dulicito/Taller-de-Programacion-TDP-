...
a. Un módulo recursivo que retorne un vector de 30 números enteros “random” 
mayores a 300 y menores a 550 (incluidos ambos).
...
{----------------------------------------------------------------------}
{INCISO A:
* parametros: vector, cant
* objetivo: modulo recursivo que retorna:
* 										vector(20 nums random) mayores
* 										a 300 y menores a 1550(incluir
* 										ambos)}
